  ...
  return (
    <div key={product.id} className="flex flex-col md:flex-row md:space-x-4 items-center space-y-4 md:space-y-0 px-4 py-2 border">
      ...
      <div className="flex flex-col items-center gap-y-1">
        <div className="capitalize text-sm">stock: <span className="font-medium">{product.stock}</span></div>
        ...
        <div className="capitalize text-sm">price: <span className="font-medium">{product.price * count}$</span></div>
      </div>
    </div>
  );
}
